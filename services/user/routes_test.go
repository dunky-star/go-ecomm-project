...
func (m *mockUserStore) UpdateUser(u payloads.User) error {
	return nil
}
...
func (m *mockUserStore) CreateUser(u payloads.User) error {
	return nil
}

func (m *mockUserStore) GetUserByID(id int) (*payloads.User, error) {
	return &payloads.User{}, nil
}